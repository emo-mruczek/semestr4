...
*/
    ...
    for (int n = 10; n <= 50; n = n + 10) {
        for (int k = 0; k < K_MAX; k++) {
            printf("%d ", n);
            results("./generate_ascending", "./merge_sort", n);
            results("./generate_ascending", "./my_sort", n);
            results("./generate_descending","./merge_sort", n);
            results("./generate_descending", "./my_sort", n);
            printf("\n");
        }
    }
   return 0;
